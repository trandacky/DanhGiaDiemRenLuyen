...
@RestController
@RequestMapping("/api/phieu-ren-luyen-kafka")
public class PhieuRenLuyenKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PhieuRenLuyenKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PhieuRenLuyenKafkaResource(KafkaProperties kafkaProperties) {
